export const module9Data = {
  ...
  themeColor: "orange",
  objectives: {
    intro: "This module aims to equip learners with the knowledge and practical skills required to understand, support, and contribute to the preparation of a Financial Condition Report (FCR).",
    points: [
      "Explain the regulatory purpose and importance of the FCR",
      "Interpret key components of an FCR",
      "Apply actuarial techniques to support financial analysis",
      "Contribute effectively to FCR preparation"
    ],
    closing: "By the end of the module, participants will strengthen their ability to translate technical findings into recommendations that inform strategic decisions by the Board and ensure compliance with professional standards."
  },
  learningOutcomes: [
    "Explain the role and purpose of the FCR in assessing an insurer's financial strength, solvency, and long-term sustainability.",
    "Identify and describe the key sections of the FCR, including business overview, profitability, reserving, asset-liability management, solvency position, reinsurance arrangements, risk management, and internal process reviews.",
    "Apply actuarial skills to support technical analysis within the FCR, such as reserve calculations, solvency assessments and asset-liability matching.",
    "Interpret and summarize technical findings in a clear and accurate way that supports decision-making by non-technical stakeholders, including the Board and regulator.",
    "Recognize governance, professional, and regulatory considerations when preparing an FCR, including confidentiality, accuracy, and transparency of actuarial advice."
  ],
  courseContent: {
    ...
    additionalResources: [
      "Draft Risk Based Capital Adequacy",
      "Guideline on Insurance Risk",
      "Guideline on Risk Management and Internal Controls",
      "Guideline on the Actuarial Function",
      "Guidelines on Actuarial Function Issued in February 2013",
      "Guidelines on Insurance Products",
      "Guidelines on Claims Management",
      "Suitability of Persons",
      "The Insurance (Investments Management) Guidelines",
      "The Insurance Act"
    ],
    aboutText: "The Financial Condition Report is a critical actuarial document that assesses an insurer's current and future financial soundness, providing comprehensive analysis of solvency, risks, and strategic recommendations to regulators and boards."
  },
  assignments: {
    dataFiles: [
      {
  ...
  quizTitle: "Quiz: Financial Condition Report (FCR)",
  quizQuestions: [
    {
      id: 1,
      section: "FCR Purpose",
