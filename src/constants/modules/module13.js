export const module13Data = {
  ...
  objectives: {
    intro: "The objective of this module is to build learners' capability to design and compute an Investment Policy Statement (IPS) by defining investment objectives, identifying key constraints, and applying basic asset allocation principles. It focuses on matching investor needs with suitable investment strategies and documenting them in a clear and practical IPS. By the end of the module, learners will understand the step-by-step process of preparing an IPS that ensures consistency, clarity, and alignment with investor goals.",
    points: [
    ...
    closing: "By the end of this module, you will have practical competence in designing and implementing comprehensive Investment Policy Statements."
  },
  ...
  courseContent: {
    description: "This module is guided by comprehensive technical documents. They contain all the instructions, worked examples, and exercises you need to master Investment Policy Statement Development. Download and use them as your primary references throughout the module.",
    resources: [
      {
  ...
  quizTitle: "Quiz: Investment Policy Statement",
