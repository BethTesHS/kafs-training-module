export const module8Data = {
  ...
  themeColor: "green",
  objectives: {
    intro: "This module aims to equip learners with the knowledge and practical skills necessary to understand, review, and prepare reinsurance certificates.",
    points: [
      "Interpret the key components of a reinsurance certificate",
      "Ensure accuracy and completeness in documentation",
      "Apply best practices in drafting and reviewing certificates",
      "Support effective reinsurance administration"
    ],
    closing: "By the end of the module, participants will be able to maintain contractual clarity and enhance compliance with both internal standards and regulatory requirements."
  },
  learningOutcomes: [
  ...
  courseContent: {
    ...
    aboutText: "Reinsurance certification is a critical function that documents the reinsurance protection arrangements between cedants and reinsurers. This module provides the technical framework and practical tools for preparing and reviewing reinsurance certificates under IFRS 17 and regulatory requirements."
  },
  assignments: {
    dataFiles: [
      {
  ...
  quizTitle: "Quiz: Reinsurance Certification",
  quizQuestions: [
    {
      id: 1,
